...
<form action="{{route('register')}}" method="POST">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <input type="text" class="form-control"placeholder="Họ" required name="txtlastname" value="{{old('txtlastname')}}">
        </div>
        </div>
        <div class="col-md-6">
        <div class="form-group">
            <input type="text" class="form-control" placeholder="Tên" required name="txtfirstname" value="{{old('txtfirstname')}}">
        </div>
        </div>
    </div>
            <div class="form-group">
                <input type="date" class="form-control" placeholder="Ngày sinh" required name="txtemail" value="{{old('txtemail')}}">
            </div>
        ...
        <div class="form-group">
            <input type="email" class="form-control" placeholder="Địa chỉ email" required name="txtemail" value="{{old('txtemail')}}">
        </div>

            <div class="form-group">
                <input type="email" class="form-control" placeholder="Điện thoại" required name="txtemail" value="{{old('txtemail')}}">
            </div>

        <div class="form-group">
            <input type="password" class="form-control" id="pwd" placeholder="Mật khẩu" required name="txtpswd" value="{{old('txtpswd')}}">
        </div>
        <div class="form-group">
