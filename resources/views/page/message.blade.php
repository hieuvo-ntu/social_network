...
<a href="{{route('index')}}" class="btn btn-outline-info">Quay trở về trang chủ</a>
        ...
        <div class="col-sm-8 conversation">
            ...
            @foreach($messages as $message)
                ...
                @if($message->user_from==Auth::user()->id)
                     <div class="col-sm-12 message-main-sender" id="{{$message->id}}">
                         <div class="sender">
                ...
                @else
                     <div class="col-sm-12 message-main-receiver" id="{{$message->id}}">
                         <div class="receiver">
                             <div class="message-text">{{$message->content}}</div>
                             <span class="message-time pull-right">{{$message->date}}</span>
                         </div>
